...
namespace SDVMMR
{
    ...
    {
        public ModInfo(string name, string author, string version, string filePath, string uid, string MiniApiVersion, string Desc, string entry, bool IsA, bool IsX, string OrgXP, bool IsAll, string[] Key)
        {
            Name = name;
            Author = author;
            Version = version;
